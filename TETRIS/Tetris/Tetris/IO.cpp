...
====================================== 
*/
void IO::DrawRectangle (int sX1, int sY1, int sX2, int sY2, enum color sC)
{
	
	
	
  boxColor (mScreen, sX1, sY1, sX2, sY2-1, mColors[sC]);
}
...
void IO::WriteText(int sX1, int sY1, int sX2, int sY2, enum color sC)
{
	//TTF_Init();
	//atexit(TTF_Quit);
